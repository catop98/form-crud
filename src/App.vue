<template>
  <div id="app" class="container">
    ...
    <Cabecera_head_main></Cabecera_head_main>
	<Form_one></Form_one>
...
import Cabecera_head_main from './components/Cabecera_head_main.vue'
import Form_one from './components/Form_one.vue'
...
#app .header ul li:last-child:before{
	display: none;
}

#app .header ul li div{
	padding: 5px;
	border-radius: 50%;
}
